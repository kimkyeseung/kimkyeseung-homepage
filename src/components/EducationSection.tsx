              ...
              <div className="flex items-start justify-between gap-2">
                ...
                {edu.curriculums && edu.curriculums.length > 0 && (
                  <button
                    ...
                    className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-300 opacity-0 group-hover:opacity-100"
