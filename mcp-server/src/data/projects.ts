...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    description:
      'MindAR + Three.js 기반 AR 콘텐츠 생성 웹 애플리케이션. 비개발자도 AR 콘텐츠 제작 가능한 노코드 플랫폼.',
  ...
  },
  {
    ...
    description:
      'Web3 온보딩 플랫폼 전면 리뉴얼. Next.js App Router 활용, 페이지 로딩 속도 40% 개선.',
  ...
  },
  {
    ...
    description:
      '심리상담 플랫폼 전문가용 웹앱. 실시간 채팅/통화 품질 개선으로 통화 성공률 72% → 99% 향상.',
